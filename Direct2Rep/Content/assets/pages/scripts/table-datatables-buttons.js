    ...
    var initTable2 = function () {
        ...
        var oTable = table.dataTable({
            ...
            buttons: [
                ...
                { extend: 'copy', className: 'btn default', exportOptions: { columns: ':not(:last-child)' } },
                //{ extend: 'pdf', className: 'btn default', exportOptions: { columns: ':not(:last-child)' }},
                { extend: 'excel', className: 'btn default', exportOptions: { columns: ':not(:last-child)' } },
                { extend: 'csv', className: 'btn default', exportOptions: { columns: ':not(:last-child)' } },
                {
                    text: 'Reload',
